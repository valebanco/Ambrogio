...
import 'package:loggingoogle/bloc.navigation_bloc/navigation_bloc.dart';
...
class InputLocationState extends State<RouteOption> with NavigationStates{
  ...
  Widget getLocationWithMapBox2(BuildContext context) {
    textBoxBuilded2 = new MapBoxLocationPicker(
      popOnSelect: true,
      apiKey: "pk.eyJ1IjoidmFsZWJhbmNvIiwiYSI6ImNqeGFrd21naTE3eDk0MXV0eTh1Z3B5bjUifQ._Ey1RoHlC0VY0wZr7y2O8Q",
      limit: 10,
      language: 'it',
      country: 'it',
      isEmptyText: (text){
        setState(() {textDestination = text; });
      },
      labelText: 'Destinazione',
      onSelected: (place) {
        setState(() {
          destination = new InformationPlace
            (place.placeName,
              place.geometry.coordinates[0],
              place.geometry.coordinates[1]);
        });
      ...
      Scaffold(
        ...
        color: Colors.white,
          child: Stack(
            ...
            Container(
              width: 200.0,
              padding: EdgeInsets.only(left:10.0,top: 250.0),
              alignment: Alignment.topLeft,
            ...
            Container(
              width: 200.0,
              margin: EdgeInsets.only(left:210.0, top:250.0),
              alignment: Alignment.topRight,
              child:getLocationWithMapBox2(context),
            ),
            ...
            Container(
              ...
              child: RaisedButton(
                ...
                child: Container(
                  ...
                  child:
                  const Text('Avvia Percorso', style: TextStyle(fontSize: 20)),
                ),
              ),
            ),
            Container(
